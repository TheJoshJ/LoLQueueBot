			...
			Embeds: []*discordgo.MessageEmbed{
				{
					...
					Fields: []*discordgo.MessageEmbedField{
						...
						{Name: "________________________", Value: "‎"},
						...
						{Name: getResult(matchHistory[4]) + " - " + matchHistory[4].GameMode,
							Value: matchHistory[4].ChampionName + "\n" + strconv.Itoa(matchHistory[4].Kills) + "/" + strconv.Itoa(matchHistory[4].Deaths) + "/" + strconv.Itoa(matchHistory[4].Assists), Inline: true},
						{Name: getResult(matchHistory[5]) + " - " + matchHistory[5].GameMode,
							Value: matchHistory[5].ChampionName + "\n" + strconv.Itoa(matchHistory[5].Kills) + "/" + strconv.Itoa(matchHistory[5].Deaths) + "/" + strconv.Itoa(matchHistory[5].Assists), Inline: true},
						{Name: "________________________", Value: "‎"},
						...
						{Name: getResult(matchHistory[9]) + " - " + matchHistory[9].GameMode,
							Value: matchHistory[9].ChampionName + "\n" + strconv.Itoa(matchHistory[9].Kills) + "/" + strconv.Itoa(matchHistory[9].Deaths) + "/" + strconv.Itoa(matchHistory[9].Assists), Inline: true},
					},
